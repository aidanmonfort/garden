...
export default {
  ...
  pages: {
    ...
    error: {
      title: "Non trovato",
      notFound: "Questa nota probabilmente non esiste ancora. Per sfruttare la natura emergente delle connessioni tra le note, faccio frequentemente riferimento a note prima che vengano create.",
