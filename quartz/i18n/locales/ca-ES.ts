...
export default {
  ...
  pages: {
    ...
    error: {
      ...
      notFound: "Aquesta nota probablement encara no existeix. Per aprofitar la naturalesa emergent de les connexions entre notes, sovint faig referència a notes abans de crear-les.",
