...
export default {
  ...
  pages: {
    ...
    error: {
      ...
      notFound: "Esta nota probablemente aún no existe. Para aprovechar la naturaleza emergente de las conexiones entre notas, frecuentemente hago referencia a notas antes de crearlas.",
