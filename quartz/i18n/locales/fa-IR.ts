...
export default {
  ...
  pages: {
    ...
    error: {
      title: "یافت نشد",
      notFound: "این یادداشت احتمالاً هنوز وجود ندارد. برای بهره‌گیری از ماهیت نوظهور ارتباطات بین یادداشت‌ها، اغلب قبل از ایجاد یادداشت‌ها به آن‌ها ارجاع می‌دهم.",
