...
export default {
  ...
  pages: {
    ...
    error: {
      ...
      notFound: "Эта заметка, вероятно, ещё не существует. Чтобы использовать эмерджентную природу связей между заметками, я часто ссылаюсь на заметки до их создания.",
