...
export default {
  ...
  pages: {
    ...
    error: {
      ...
      notFound: "Ta notatka prawdopodobnie jeszcze nie istnieje. Aby wykorzystać emergentny charakter połączeń między notatkami, często odwołuję się do notatek, zanim zostaną stworzone.",
