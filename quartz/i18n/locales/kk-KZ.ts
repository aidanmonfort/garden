...
export default {
  ...
  pages: {
    ...
    error: {
      title: "Табылмады",
      notFound: "Бұл жазба әлі жоқ болуы мүмкін. Жазбалар арасындағы байланыстардың пайда болу сипатын пайдалану үшін, мен жиі жасалмаған жазбаларға сілтеме жасаймын.",
